...
import com.example.week09.activities.BookDetailActivity;
...
public class GetSingleBookAsyncTask extends AsyncTask<Long, Integer, Book> {
    ...
    public GetSingleBookAsyncTask(AppDatabase database){
    ...
    protected Book doInBackground(Long... isbn) {
        ...
        System.out.println("Long: " + isbn);
        // TODO: Write your code to perform the task
        long longISBN = isbn[0].longValue();
        System.out.println("long primitive: " + longISBN);
        ...
        return database.bookDao().findBookByIsbn(longISBN);
    }
